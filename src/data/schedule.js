...
export function buildDay({ date, phaseId, outdoor, pureDiaStart }) {
  ...
  const am = [
    ...
    },
    {
      ...
      title: 'Hair',
      note: mask
        ? 'Wash at night instead? Mask and leave-in then, but the curl cream, the scrunch and the diffuse need the morning — re-wet properly first, not just a mist.'
      ...
      steps: mask
        ? [
            ...
            { id: 'am-diffuse', productId: 'diffuser', title: 'Diffuse — low heat, low speed', detail: 'Cup a section into the bowl, hold still 20–30 seconds, lower away, next section. Never wave it around. Tilt your head side to side for root volume.', badge: 'Low + slow' },
            { id: 'am-cool', title: 'Cool shot, then hands off', detail: 'At about 90% dry switch to cool for the last pass — cooling is what sets the shape. Then leave it completely alone until bone dry.' },
        ...
        : [
            ...
            { id: 'am-airdry', title: 'Air dry — hands off', detail: 'Leave it alone until dry. A short low-heat diffuse speeds this up on a refresh too, if you are in a hurry.', optional: true, optionalNote: 'or diffuse briefly' },
